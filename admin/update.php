    ...
    <h1 class="text-center my-5">Create Books</h1>
        <div class="container-fluid cont">
            <div class="row">
                ...
                <form action="update-post.php" class="border p-5 text-dark" method="post">
<div class="row">
    <div class="col-6">
     Name:   <input type="text" name="name" value="<?= $book['name']?>" class="form-control bordered">
    </div>
    <div class="col-6">
        Image:
        <input type="text" name="image" value="<?= $book['image']?>" class="form-control bordered">
    </div>
</div>
<div class="row my-5">
    <div class="col-6">
...
<div class="row">
    <div class="col-6">
        Price:
        <input type="text" name="price" value="<?= $book['price']?>" class="form-control bordered">
    </div>
    <div class="col-6">
        Input Some Text:
        <textarea name="description" value="<?= $book['description']?>" class="form-control"   cols="4" rows="3"></textarea>
</div>
<div class="row">
