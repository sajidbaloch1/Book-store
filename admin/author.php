...
<a href="" class="btn btn-success mt-5" onclick="create()">Create</a>
        ...
        <div class="row">
            <table class="table table-bordered text-center table-hover">
                ...
                <tr>
                    ...
                    <form action="del-aut.php" method="POST">
                ...
                <table class="table" id="create"> 
                    <tr>
                        <form action="aut-crepos.php"  method="POST">
                            <td ></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="upd-autpos.php" method="POST">
